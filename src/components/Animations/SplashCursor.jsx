...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    const backgroundProgram = new Program(baseVertexShader, backgroundShader);
    ...
    canvas.addEventListener('mousemove', (e) => {
      ...
      pointer.texcoordX = pointer.x / canvas.width;
      pointer.texcoordY = 1.0 - pointer.y / canvas.height;
      pointer.deltaX = correctDeltaX(pointer.dx);
      pointer.deltaY = correctDeltaY(pointer.dy);
      pointer.down = true;
    });
    ...
    // Add return statement for cleanup
    return () => {
      if (gl) {
